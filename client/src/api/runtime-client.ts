...
export interface ThesisQueryDetail extends ThesisQuerySummary { readonly propositions: readonly ThesisQueryProposition[]; readonly propositionRefs: readonly string[]; readonly membershipEdgeRefs: readonly string[]; readonly revision: number }
