...
export interface ResearchBundleSummary { readonly bundleId: string; readonly workflowRunId: string; readonly createdAt: string; readonly status: string; readonly report?: { readonly reportId: string; readonly reportPath?: string }; readonly proposals: readonly { readonly proposalId: string; readonly kind?: string }[] }
...
export class RuntimeClient {
  ...
  async getResearchBundle(bundleId: string): Promise<ResearchBundleSummary & { readonly structuredResult: unknown }> { return this.request(`/api/research/bundles/${encodeURIComponent(bundleId)}`) }
