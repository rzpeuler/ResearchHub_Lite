...
export function findKnowledgeSchemaRelease(version: { schemaVersion: string; storageFormatVersion: string }): KnowledgeSchemaRelease | undefined {
  return (version.schemaVersion === '0.3' || version.schemaVersion === '0.4') && version.storageFormatVersion === '1'
    ? { schemaVersion: version.schemaVersion, storageFormatVersion: '1', readable: true, writable: true }
    : undefined
}
