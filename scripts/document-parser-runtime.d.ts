...
export declare const PYSOCKS_VERSION: string
export declare const PYPI_INDEX: string
...
export declare function configuredWindowsProxy(platform?: string, execute?: Execute): Promise<string | undefined>
