...
export declare function bootstrapPlan(platform?: string, paths?: { venv: string; models: string }): { venv: { executable: string; args: string[]; systemSitePackages: boolean }; install: { executable: string; args: string[] }; models: { executable: string; args: string[] } }
...
export declare function setup(options?: { root?: string; platform?: string; explicitPython?: string; execute?: Execute }): Promise<{ status: string; reason?: string; pythonReady?: boolean; dependencyReady?: boolean; artifactsReady?: boolean; bridgeReady?: boolean }>
