...
export function allocateRelationId(type: string, sourceRef: string, targetRef: string, attributes: unknown): string { return allocateKnowledgeIdBase('relation', { type, sourceRef, targetRef, attributes }) }
