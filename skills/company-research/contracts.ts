import type { NormalizedResearchSource, ResearchCompanyIdentity, ResearchAcquisitionDiagnostic, ResearchProviderOutcome } from '../../plugins/research-acquisition/contracts.ts'
