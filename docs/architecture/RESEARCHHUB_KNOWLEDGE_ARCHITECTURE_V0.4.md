...
3. Earnings Review creates an `earnings_release` Event, reported Metric Observations for the historical fiscal period, Claim evidence, and optional Thesis/ReasoningEdge updates. Acquisition time is stored on Source and is distinct from the reported period.
