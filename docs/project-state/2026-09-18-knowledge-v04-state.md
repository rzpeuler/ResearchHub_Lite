...
Status: PASS / acceptance verified 2026-09-18.
...
The artifact records K1–K10 as true: schema contract, storage/reload, validator, Gateway atomic path, query, rights fail-closed, Earnings Review vertical, migration, replay idempotency, and ReviewCase persistence. It intentionally excludes raw bodies, credentials, private paths, and reasoning traces.
