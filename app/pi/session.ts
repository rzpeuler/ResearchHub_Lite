...
export async function createResearchHubPiSession(options: ResearchHubPiSessionOptions): Promise<ResearchHubPiSession> {
  ...
  const customTools = createResearchHubTools({ knowledgeService, productionService, reviewService, workflowService, researchService: options.researchService ?? applicationServices.researchService, thesisQueryService: applicationServices.thesisQueryService, thesisDecisionService: applicationServices.thesisDecisionService, dailyIntelligenceService: options.dailyIntelligenceService ?? applicationServices.dailyIntelligenceService, sourceLibraryService: applicationServices.sourceLibraryService, mountedKnowledgeBaseRoot, skillOnboardingService: applicationServices.skillOnboardingService, researchDispatchService: applicationServices.researchDispatchService, resourceLoader: loader, piNativeSkillsRoot: join(resolve(options.cwd), '.pi', 'skills'), policyContext: options.policyContext })
