...
export interface DailyBriefInput { readonly workflowRunId: string; readonly briefType: DailyBriefType; readonly tradeDate: string; readonly asOf?: string; readonly forceRefresh?: boolean; readonly writeKnowledge?: boolean }
