...
export class ResearchService {
  ...
  startIndustryResearch(input: IndustryResearchInput, callerSignal?: AbortSignal): { readonly runId: string; readonly completion: Promise<ApplicationIndustryResearchResult> } {
    ...
    const reasoningExecutor = this.options.reasoningExecutor
    if (!reasoningExecutor) throw new ApplicationServiceError('failed', 'Industry Research requires a configured ReasoningExecutor')
