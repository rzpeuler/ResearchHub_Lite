...
export interface ResearchReport {
  ...
  readonly reportType: 'company_research' | 'daily_brief' | 'earnings_review' | 'valuation'
...
export function validateResearchReport(report: ResearchReport): ResearchReport {
  ...
  if (report.reportType !== 'company_research' && report.reportType !== 'daily_brief' && report.reportType !== 'earnings_review' && report.reportType !== 'valuation') throw new TypeError('Unsupported reportType')
...
export function renderResearchReport(report: ResearchReport): string {
  const title = report.reportType === 'daily_brief' ? 'Daily Intelligence Brief' : report.reportType === 'earnings_review' ? 'Earnings Review' : report.reportType === 'valuation' ? 'Valuation' : 'Company Research'
